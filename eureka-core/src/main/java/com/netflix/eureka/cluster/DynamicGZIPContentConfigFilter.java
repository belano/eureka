...
public class DynamicGZIPContentConfigFilter implements ClientRequestFilter, ClientResponseFilter {
    private final EurekaServerConfig config;

    public DynamicGZIPContentConfigFilter(EurekaServerConfig config) {
        this.config = config;
    }
